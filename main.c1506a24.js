                                                ...
                                                for (var i in o)
                                                    if ((r[i] || 0) < o[i])
                                                        return {
                                                            validGuess: !1,
                                                            errorMessage:
                                                                "El intento debe contener ".concat(
                                                                    i.toUpperCase()
                                                                ),
                                                        };
                                                return { validGuess: !0 };
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e =
                                    ...
                                    a = Math.min(
                                        Math.floor(e.clientHeight * (5 / 10)),
                                        350
                                    ),
                                    s = 10 * Math.floor(a / 5);
                                        ...
                                        function (a) {
                                            ...
                                            switch (t) {
                                                case "hard-mode":
                                                    return void (n
                                                        ? e.addToast(
                                                              "El modo difícil solo puede activarse al inicio de una ronda",
                                                              1500,
                                                              !0
                                                          )
                                                        : ((e.hardMode = o),
        ...
        Ps.innerHTML = `<style>
            ...
            <section>
              <div class="instructions">
                ...
                <p>Esta es una adaptación sencilla del <strong><a href="https://www.powerlanguage.co.uk/wordle/" target="blank" title="@powerlanguish">Wordle</a></strong> de Josh Wardle.</p>
                <p>Cada intento debe ser un número válido de 5 dígitos. Presiona la tecla Enter para enviar.</p>
                <p>Después de cada intento, el color de las casillas cambiará para mostrar qué tan cerca estuvo tu intento del número.</p>
                <div class="examples">
                ...
                <p><strong>¡Un nuevo NUMBERLE estará disponible cada día!<strong></p>
              </div>
            </section>`;
        var Hs = (function (e) {
            r(t, e);
